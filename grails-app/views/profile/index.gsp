                ...
                <form name="update" class="form-horizontal" method="post" action="/Profile/update">
                    ...
                    <div class="form-group ${hasErrors(bean: userData, field: 'firstName', 'has-error')}">
                        ...
                        <div class="col-lg-6 top-pad">
                            <input type="text" class="form-control try" name="firstName" id="firstName" value="${userData.firstName}" required>
                    ...
                    <div class="form-group ${hasErrors(bean: userData, field: 'lastName', 'has-error')}">
                        ...
                        <div class="col-lg-6 top-pad">
                            <input type="text" class="form-control try" name="lastName" id="lastName" value="${userData.lastName}" required>
                    ...
                    <div class="form-group ${hasErrors(bean: userData, field: 'password', 'has-error')}">
                        ...
                        <div class="col-lg-3 top-pad">
                            <input type="password" class="form-control try" name="password" id="password" value="${userData.password}" required>
                            <g:renderErrors bean="${userData}" field="password" />
                        </div>
                        <div class="col-lg-3 top-pad">
                            <input type="password" class="form-control try" name="newPassword" id="newPassword"
